...
var queryGameByName = exports.queryGameByName = function queryGameByName(name, Game) {
    //search a game
    (async function () {
        var game = await Game.findAll({
            limit: 10,
        ...
        try {
            for (var _iterator2 = game[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                var p = _step2.value;
